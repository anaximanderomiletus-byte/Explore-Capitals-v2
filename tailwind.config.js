...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'premium': '0 8px 32px 0 rgba(0, 122, 255, 0.15)',
        'premium-hover': '0 12px 48px 0 rgba(0, 122, 255, 0.25)',
        'glass': '0 8px 32px 0 rgba(31, 38, 135, 0.37)',
        'glass-bubble': '0 15px 35px rgba(0, 0, 0, 0.2), 0 0 0 1px rgba(255, 255, 255, 0.15), inset 0 1px 2px rgba(255, 255, 255, 0.8), inset 0 -4px 10px rgba(0, 0, 0, 0.1), inset 0 4px 12px rgba(255, 255, 255, 0.4)',
        'inner-gloss': 'inset 0 1px 1px rgba(255, 255, 255, 0.4), inset 0 -1px 1px rgba(0, 0, 0, 0.1)',
        'glow-primary': '0 0 20px rgba(0, 122, 255, 0.6)',
        'glow-sky': '0 0 30px rgba(119, 182, 234, 0.6)',
        'glow-accent': '0 0 30px rgba(34, 197, 94, 0.6)',
        'glow-white': '0 0 20px rgba(255, 255, 255, 0.4)',
        'glow-warning': '0 0 30px rgba(255, 149, 0, 0.5)',
        'logo-glow': '0 0 40px rgba(0, 191, 255, 0.5)',
      },
      backgroundImage: {
