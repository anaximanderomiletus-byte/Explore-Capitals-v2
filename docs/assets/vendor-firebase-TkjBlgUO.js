 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pd{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(Sd(t)){const r=t.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(t=>t).join(" ")}}function Sd(n){const e=n.getComponent();return e?.type==="VERSION"}const os="@firebase/app",Da="0.10.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ge=new Ss("@firebase/app"),Cd="@firebase/app-compat",bd="@firebase/analytics-compat",kd="@firebase/analytics",Vd="@firebase/app-check-compat",Nd="@firebase/app-check",Dd="@firebase/auth",Od="@firebase/auth-compat",Ld="@firebase/database",Md="@firebase/data-connect",xd="@firebase/database-compat",Fd="@firebase/functions",Ud="@firebase/functions-compat",Bd="@firebase/installations",jd="@firebase/installations-compat",qd="@firebase/messaging",$d="@firebase/messaging-compat",zd="@firebase/performance",Wd="@firebase/performance-compat",Hd="@firebase/remote-config",Kd="@firebase/remote-config-compat",Gd="@firebase/storage",Qd="@firebase/storage-compat",Jd="@firebase/firestore",Yd="@firebase/vertexai-preview",Xd="@firebase/firestore-compat",Zd="firebase",ef="10.14.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const as="[DEFAULT]",tf={[os]:"fire-core",[Cd]:"fire-core-compat",[kd]:"fire-analytics",[bd]:"fire-analytics-compat",[Nd]:"fire-app-check",[Vd]:"fire-app-check-compat",[Dd]:"fire-auth",[Od]:"fire-auth-compat",[Ld]:"fire-rtdb",[Md]:"fire-data-connect",[xd]:"fire-rtdb-compat",[Fd]:"fire-fn",[Ud]:"fire-fn-compat",[Bd]:"fire-iid",[jd]:"fire-iid-compat",[qd]:"fire-fcm",[$d]:"fire-fcm-compat",[zd]:"fire-perf",[Wd]:"fire-perf-compat",[Hd]:"fire-rc",[Kd]:"fire-rc-compat",[Gd]:"fire-gcs",[Qd]:"fire-gcs-compat",[Jd]:"fire-fst",[Xd]:"fire-fst-compat",[Yd]:"fire-vertex","fire-js":"fire-js",[Zd]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $r=new Ss("@firebase/auth");function _f(n,...e){$r.logLevel<=j.WARN&&$r.warn(`Auth (${on}): ${n}`,...e)}function Dr(n,...e){$r.logLevel<=j.ERROR&&$r.error(`Auth (${on}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ns(n,e){Qe(n.emulator,"Emulator should always be set here");const{url:t}=n.emulator;return e?`${t}${e.startsWith("/")?e.slice(1):e}`:t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ln(n){if(n)try{const e=new Date(Number(n));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function Cf(n,e=!1){const t=Q(n),r=await t.getIdToken(e),i=Ds(r);N(i&&i.exp&&i.auth_time&&i.iat,t.auth,"internal-error");const o=typeof i.firebase=="object"?i.firebase:void 0,a=o?.sign_in_provider;return{claims:i,token:r,authTime:Ln(Ji(i.auth_time)),issuedAtTime:Ln(Ji(i.iat)),expirationTime:Ln(Ji(i.exp)),signInProvider:a||null,signInSecondFactor:o?.sign_in_second_factor||null}}function Ji(n){return Number(n)*1e3}function Ds(n){const[e,t,r]=n.split(".");if(e===void 0||t===void 0||r===void 0)return Dr("JWT malformed, contained fewer than 3 sections"),null;try{const i=qc(t);return i?JSON.parse(i):(Dr("Failed to decode base64 JWT payload"),null)}catch(i){return Dr("Caught error parsing JWT payload as JSON",i?.toString()),null}}function ja(n){const e=Ds(n);return N(e,"internal-error"),N(typeof e.exp<"u","internal-error"),N(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qn(n){var e;const t=n.auth,r=await n.getIdToken(),i=await Je(n,iu(t,{idToken:r}));N(i?.users.length,t,"internal-error");const o=i.users[0];n._notifyReloadListener(o);const a=!((e=o.providerUserInfo)===null||e===void 0)&&e.length?su(o.providerUserInfo):[],u=Nf(n.providerData,a),h=n.isAnonymous,d=!(n.email&&o.passwordHash)&&!u?.length,p=h?d:!1,I={uid:o.localId,displayName:o.displayName||null,photoURL:o.photoUrl||null,email:o.email||null,emailVerified:o.emailVerified||!1,phoneNumber:o.phoneNumber||null,tenantId:o.tenantId||null,providerData:u,metadata:new ls(o.createdAt,o.lastLoginAt),isAnonymous:p};Object.assign(n,I)}async function Vf(n){const e=Q(n);await qn(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function Nf(n,e){return[...n.filter(r=>!e.some(i=>i.providerId===r.providerId)),...e]}function su(n){return n.map(e=>{var{providerId:t}=e,r=ks(e,["providerId"]);return{providerId:t,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Df(n,e){const t=await nu(n,{},async()=>{const r=sn({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:i,apiKey:o}=n.config,a=ru(n,i,"/v1/token",`key=${o}`),u=await n._getAdditionalHeaders();return u["Content-Type"]="application/x-www-form-urlencoded",tu.fetch()(a,{method:"POST",headers:u,body:r})});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function Of(n,e){return ae(n,"POST","/v2/accounts:revokeToken",oe(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wt{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){N(e.idToken,"internal-error"),N(typeof e.idToken<"u","internal-error"),N(typeof e.refreshToken<"u","internal-error");const t="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):ja(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}updateFromIdToken(e){N(e.length!==0,"internal-error");const t=ja(e);this.updateTokensAndExpiration(e,null,t)}async getToken(e,t=!1){return!t&&this.accessToken&&!this.isExpired?this.accessToken:(N(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:r,refreshToken:i,expiresIn:o}=await Df(e,t);this.updateTokensAndExpiration(r,i,Number(o))}updateTokensAndExpiration(e,t,r){this.refreshToken=t||null,this.accessToken=e||null,this.expirationTime=Date.now()+r*1e3}static fromJSON(e,t){const{refreshToken:r,accessToken:i,expirationTime:o}=t,a=new Wt;return r&&(N(typeof r=="string","internal-error",{appName:e}),a.refreshToken=r),i&&(N(typeof i=="string","internal-error",{appName:e}),a.accessToken=i),o&&(N(typeof o=="number","internal-error",{appName:e}),a.expirationTime=o),a}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new Wt,this.toJSON())}_performRefresh(){return xe("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qf(n,e){const t=bs(n,"auth");if(t.isInitialized()){const i=t.getImmediate(),o=t.getOptions();if(qr(o,e??{}))return i;Ve(i,"already-initialized")}return t.initialize({options:e})}function Jf(n,e){const t=e?.persistence||[],r=(Array.isArray(t)?t:[t]).map(Ke);e?.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e?.popupRedirectResolver)}function Yf(n,e,t){const r=De(n);N(r._canInitEmulator,r,"emulator-config-failed"),N(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const i=!1,o=_u(e),{host:a,port:u}=Xf(e),h=u===null?"":`:${u}`;r.config.emulator={url:`${o}//${a}${h}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:a,port:u,protocol:o.replace(":",""),options:Object.freeze({disableWarnings:i})}),Zf()}function _u(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function Xf(n){const e=_u(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(r);if(i){const o=i[1];return{host:o,port:Ka(r.substr(o.length+1))}}else{const[o,a]=r.split(":");return{host:o,port:Ka(a)}}}function Ka(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function Zf(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class an{constructor(){this.providerId=an.PROVIDER_ID}static credential(e,t){return $n._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const r=xs.parseLink(t);return N(r,"argument-error"),$n._fromEmailAndCode(e,r.code,r.tenantId)}}an.PROVIDER_ID="password";an.EMAIL_PASSWORD_SIGN_IN_METHOD="password";an.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vp(n){return new Set(n.map(({providerId:e})=>e).filter(e=>!!e))}async function Eu(n,e,t=!1){const r=await Je(n,e._linkToIdToken(n.auth,await n.getIdToken()),t);return Ye._forOperation(n,"link",r)}async function Ep(n,e,t){await qn(e);const r=vp(e.providerData);N(r.has(t)===n,e.auth,"provider-already-linked")}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class js{constructor(e,t,r){this.session=e,this.hints=t,this.signInResolver=r}static _fromError(e,t){const r=De(e),i=t.customData._serverResponse,o=(i.mfaInfo||[]).map(u=>si._fromServerResponse(r,u));N(i.mfaPendingCredential,r,"internal-error");const a=Pt._fromMfaPendingCredential(i.mfaPendingCredential);return new js(a,o,async u=>{const h=await u._process(r,a);delete i.mfaInfo,delete i.mfaPendingCredential;const d=Object.assign(Object.assign({},i),{idToken:h.idToken,refreshToken:h.refreshToken});switch(t.operationType){case"signIn":const p=await Ye._fromIdTokenResponse(r,t.operationType,d);return await r._updateCurrentUser(p.user),p;case"reauthenticate":return N(t.user,r,"internal-error"),Ye._forOperation(t.user,t.operationType,d);default:Ve(r,"internal-error")}})}async resolveSignIn(e){const t=e;return this.signInResolver(t)}}function Pv(n,e){var t;const r=Q(n),i=e;return N(e.customData.operationType,r,"argument-error"),N((t=i.customData._serverResponse)===null||t===void 0?void 0:t.mfaPendingCredential,r,"argument-error"),js._fromError(r,i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function se(){return window}function Dp(n){se().location.href=n}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xi=gu("rcb"),Jp=new Xn(3e4,6e4);class Yp{constructor(){var e;this.hostLanguage="",this.counter=0,this.librarySeparatelyLoaded=!!(!((e=se().grecaptcha)===null||e===void 0)&&e.render)}load(e,t=""){return N(Xp(t),e,"argument-error"),this.shouldResolveImmediately(t)&&Ua(se().grecaptcha)?Promise.resolve(se().grecaptcha):new Promise((r,i)=>{const o=se().setTimeout(()=>{i(be(e,"network-request-failed"))},Jp.get());se()[Xi]=()=>{se().clearTimeout(o),delete se()[Xi];const u=se().grecaptcha;if(!u||!Ua(u)){i(be(e,"internal-error"));return}const h=u.render;u.render=(d,p)=>{const I=h(d,p);return this.counter++,I},this.hostLanguage=t,r(u)};const a=`${$f()}?${sn({onload:Xi,render:"explicit",hl:t})}`;Ls(a).catch(()=>{clearTimeout(o),i(be(e,"internal-error"))})})}clearedOneInstance(){this.counter--}shouldResolveImmediately(e){var t;return!!(!((t=se().grecaptcha)===null||t===void 0)&&t.render)&&(e===this.hostLanguage||this.counter>0||this.librarySeparatelyLoaded)}}function Xp(n){return n.length<=6&&/^\s*[a-zA-Z0-9\-]*\s*$/.test(n)}class Zp{async load(e){return new Kp(e)}clearedOneInstance(){}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nm{constructor(e,t){this.verificationId=e,this.onConfirmation=t}confirm(e){const t=Ct._fromVerification(this.verificationId,e);return this.onConfirmation(t)}}async function bv(n,e,t){if(Le(n.app))return Promise.reject(Fe(n));const r=De(n),i=await Nu(r,e,Q(t));return new nm(i,o=>wu(r,o))}async function Nu(n,e,t){var r;const i=await t.verify();try{N(typeof i=="string",n,"argument-error"),N(t.type===Vu,n,"argument-error");let o;if(typeof e=="string"?o={phoneNumber:e}:o=e,"session"in o){const a=o.session;if("phoneNumber"in o)return N(a.type==="enroll",n,"internal-error"),(await Rp(n,{idToken:a.credential,phoneEnrollmentInfo:{phoneNumber:o.phoneNumber,recaptchaToken:i}})).phoneSessionInfo.sessionInfo;{N(a.type==="signin",n,"internal-error");const u=((r=o.multiFactorHint)===null||r===void 0?void 0:r.uid)||o.multiFactorUid;return N(u,n,"missing-multi-factor-info"),(await $p(n,{mfaPendingCredential:a.credential,mfaEnrollmentId:u,phoneSignInInfo:{recaptchaToken:i}})).phoneResponseInfo.sessionInfo}}else{const{sessionInfo:a}=await hp(n,{phoneNumber:o.phoneNumber,recaptchaToken:i});return a}}finally{t._reset()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rm(n,e){return e?Ke(e):(N(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Du{constructor(e,t,r,i,o=!1){this.auth=e,this.resolver=r,this.user=i,this.bypassAuthState=o,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:r,postBody:i,tenantId:o,error:a,type:u}=e;if(a){this.reject(a);return}const h={auth:this.auth,requestUri:t,sessionId:r,tenantId:o||void 0,postBody:i||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(u)(h))}catch(d){this.reject(d)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return im;case"linkViaPopup":case"linkViaRedirect":return om;case"reauthViaPopup":case"reauthViaRedirect":return sm;default:Ve(this.auth,"internal-error")}}resolve(e){Qe(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Qe(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cm="pendingRedirect",Lr=new Map;class um extends Du{constructor(e,t,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,r),this.eventId=null}async execute(){let e=Lr.get(this.auth._key());if(!e){try{const r=await lm(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(t){e=()=>Promise.reject(t)}Lr.set(this.auth._key(),e)}return this.bypassAuthState||Lr.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function lm(n,e){const t=fm(e),r=dm(n);if(!await r._isAvailable())return!1;const i=await r._get(t)==="true";return await r._remove(t),i}function hm(n,e){Lr.set(n._key(),e)}function dm(n){return Ke(n._redirectPersistence)}function fm(n){return Or(cm,n.config.apiKey,n.name)}async function pm(n,e,t=!1){if(Le(n.app))return Promise.reject(Fe(n));const r=De(n),i=rm(r,e),a=await new um(r,i,t).execute();return a&&!t&&(delete a.user._redirectEventId,await r._persistUserIfCurrent(a.user),await r._setRedirectUser(null,e)),a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pm=new Xn(5e3,15e3),Sm="__/auth/iframe",Cm="emulator/auth/iframe",bm={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},km=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Vm(n){const e=n.config;N(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?Ns(e,Cm):`https://${n.config.authDomain}/${Sm}`,r={apiKey:e.apiKey,appName:n.name,v:on},i=km.get(n.config.apiHost);i&&(r.eid=i);const o=n._getFrameworks();return o.length&&(r.fw=o.join(",")),`${t}?${sn(r).slice(1)}`}async function Nm(n){const e=await Rm(n),t=se().gapi;return N(t,n,"internal-error"),e.open({where:document.body,url:Vm(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:bm,dontclear:!0},r=>new Promise(async(i,o)=>{await r.restyle({setHideOnLeave:!1});const a=be(n,"network-request-failed"),u=se().setTimeout(()=>{o(a)},Pm.get());function h(){se().clearTimeout(u),i(r)}r.ping(h).then(h,()=>{o(a)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dm={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},Om=500,Lm=600,Mm="_blank",xm="http://localhost";class Za{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function Fm(n,e,t,r=Om,i=Lm){const o=Math.max((window.screen.availHeight-i)/2,0).toString(),a=Math.max((window.screen.availWidth-r)/2,0).toString();let u="";const h=Object.assign(Object.assign({},Dm),{width:r.toString(),height:i.toString(),top:o,left:a}),d=we().toLowerCase();t&&(u=uu(d)?Mm:t),au(d)&&(e=e||xm,h.scrollbars="yes");const p=Object.entries(h).reduce((A,[P,V])=>`${A}${P}=${V},`,"");if(Lf(d)&&u!=="_self")return Um(e||"",u),new Za(null);const I=window.open(e||"",u,p);N(I,n,"popup-blocked");try{I.focus()}catch{}return new Za(I)}function Um(n,e){const t=document.createElement("a");t.href=n,t.target=e;const r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bm="__/auth/handler",jm="emulator/auth/handler",qm=encodeURIComponent("fac");async function ec(n,e,t,r,i,o){N(n.config.authDomain,n,"auth-domain-config-required"),N(n.config.apiKey,n,"invalid-api-key");const a={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:r,v:on,eventId:i};if(e instanceof yu){e.setDefaultLanguage(n.languageCode),a.providerId=e.providerId||"",Zh(e.getCustomParameters())||(a.customParameters=JSON.stringify(e.getCustomParameters()));for(const[p,I]of Object.entries({}))a[p]=I}if(e instanceof er){const p=e.getScopes().filter(I=>I!=="");p.length>0&&(a.scopes=p.join(","))}n.tenantId&&(a.tid=n.tenantId);const u=a;for(const p of Object.keys(u))u[p]===void 0&&delete u[p];const h=await n._getAppCheckToken(),d=h?`#${qm}=${encodeURIComponent(h)}`:"";return`${$m(n)}?${sn(u).slice(1)}${d}`}function $m({config:n}){return n.emulator?Ns(n,jm):`https://${n.authDomain}/${Bm}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nt=new Ss("@firebase/firestore");function Cn(){return Nt.logLevel}function D(n,...e){if(Nt.logLevel<=j.DEBUG){const t=e.map(Ks);Nt.debug(`Firestore (${cn}): ${n}`,...t)}}function Xe(n,...e){if(Nt.logLevel<=j.ERROR){const t=e.map(Ks);Nt.error(`Firestore (${cn}): ${n}`,...t)}}function Yt(n,...e){if(Nt.logLevel<=j.WARN){const t=e.map(Ks);Nt.warn(`Firestore (${cn}): ${n}`,...t)}}function Ks(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function nr(n){if(n.code!==C.FAILED_PRECONDITION||n.message!==mg)throw n;D("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class L_{constructor(e,t){this.qr={},this.overlays={},this.Qr=new Gs(0),this.Kr=!1,this.Kr=!0,this.$r=new k_,this.referenceDelegate=e(this),this.Ur=new O_(this),this.indexManager=new w_,this.remoteDocumentCache=(function(i){return new N_(i)})((r=>this.referenceDelegate.Wr(r))),this.serializer=new T_(t),this.Gr=new C_(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.Kr=!1,Promise.resolve()}get started(){return this.Kr}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let t=this.overlays[e.toKey()];return t||(t=new b_,this.overlays[e.toKey()]=t),t}getMutationQueue(e,t){let r=this.qr[e.toKey()];return r||(r=new V_(t,this.referenceDelegate),this.qr[e.toKey()]=r),r}getGlobalsCache(){return this.$r}getTargetCache(){return this.Ur}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Gr}runTransaction(e,t,r){D("MemoryPersistence","Starting transaction:",e);const i=new M_(this.Qr.next());return this.referenceDelegate.zr(),r(i).next((o=>this.referenceDelegate.jr(i).next((()=>o)))).toPromise().then((o=>(i.raiseOnCommittedEvent(),o)))}Hr(e,t){return S.or(Object.values(this.qr).map((r=>()=>r.containsKey(e,t))))}}class M_ extends gg{constructor(e){super(),this.currentSequenceNumber=e}}class ao{constructor(e){this.persistence=e,this.Jr=new oo,this.Yr=null}static Zr(e){return new ao(e)}get Xr(){if(this.Yr)return this.Yr;throw x()}addReference(e,t,r){return this.Jr.addReference(r,t),this.Xr.delete(r.toString()),S.resolve()}removeReference(e,t,r){return this.Jr.removeReference(r,t),this.Xr.add(r.toString()),S.resolve()}markPotentiallyOrphaned(e,t){return this.Xr.add(t.toString()),S.resolve()}removeTarget(e,t){this.Jr.gr(t.targetId).forEach((i=>this.Xr.add(i.toString())));const r=this.persistence.getTargetCache();return r.getMatchingKeysForTargetId(e,t.targetId).next((i=>{i.forEach((o=>this.Xr.add(o.toString())))})).next((()=>r.removeTargetData(e,t)))}zr(){this.Yr=new Set}jr(e){const t=this.persistence.getRemoteDocumentCache().newChangeBuffer();return S.forEach(this.Xr,(r=>{const i=M.fromPath(r);return this.ei(e,i).next((o=>{o||t.removeEntry(i,F.min())}))})).next((()=>(this.Yr=null,t.apply(e))))}updateLimboDocument(e,t){return this.ei(e,t).next((r=>{r?this.Xr.delete(t.toString()):this.Xr.add(t.toString())}))}Wr(e){return 0}ei(e,t){return S.or([()=>S.resolve(this.Jr.containsKey(t)),()=>this.persistence.getTargetCache().containsKey(e,t),()=>this.persistence.Hr(e,t)])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cc{constructor(){this.ao=()=>this.uo(),this.co=()=>this.lo(),this.ho=[],this.Po()}_o(e){this.ho.push(e)}shutdown(){window.removeEventListener("online",this.ao),window.removeEventListener("offline",this.co)}Po(){window.addEventListener("online",this.ao),window.addEventListener("offline",this.co)}uo(){D("ConnectivityMonitor","Network connectivity changed: AVAILABLE");for(const e of this.ho)e(0)}lo(){D("ConnectivityMonitor","Network connectivity changed: UNAVAILABLE");for(const e of this.ho)e(1)}static D(){return typeof window<"u"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ee="WebChannelConnection";class Y_ extends class{constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const r=t.ssl?"https":"http",i=encodeURIComponent(this.databaseId.projectId),o=encodeURIComponent(this.databaseId.database);this.Do=r+"://"+t.host,this.vo=`projects/${i}/databases/${o}`,this.Co=this.databaseId.database==="(default)"?`project_id=${i}`:`project_id=${i}&database_id=${o}`}get Fo(){return!1}Mo(t,r,i,o,a){const u=ts(),h=this.xo(t,r.toUriEncodedString());D("RestConnection",`Sending RPC '${t}' ${u}:`,h,i);const d={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(d,o,a),this.No(t,h,d,i).then((p=>(D("RestConnection",`Received RPC '${t}' ${u}: `,p),p)),(p=>{throw Yt("RestConnection",`RPC '${t}' ${u} failed with error: `,p,"url: ",h,"request:",i),p}))}Lo(t,r,i,o,a,u){return this.Mo(t,r,i,o,a)}Oo(t,r,i){t["X-Goog-Api-Client"]=(function(){return"gl-js/ fire/"+cn})(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach(((o,a)=>t[a]=o)),i&&i.headers.forEach(((o,a)=>t[a]=o))}xo(t,r){const i=Q_[t];return`${this.Do}/v1/${r}:${i}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}No(e,t,r,i){const o=ts();return new Promise(((a,u)=>{const h=new Mu;h.setWithCredentials(!0),h.listenOnce(xu.COMPLETE,(()=>{try{switch(h.getLastErrorCode()){case xr.NO_ERROR:const p=h.getResponseJson();D(Ee,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(p)),a(p);break;case xr.TIMEOUT:D(Ee,`RPC '${e}' ${o} timed out`),u(new L(C.DEADLINE_EXCEEDED,"Request time out"));break;case xr.HTTP_ERROR:const I=h.getStatus();if(D(Ee,`RPC '${e}' ${o} failed with status:`,I,"response text:",h.getResponseText()),I>0){let A=h.getResponseJson();Array.isArray(A)&&(A=A[0]);const P=A?.error;if(P&&P.status&&P.message){const V=(function(k){const W=k.toLowerCase().replace(/_/g,"-");return Object.values(C).indexOf(W)>=0?W:C.UNKNOWN})(P.status);u(new L(V,P.message))}else u(new L(C.UNKNOWN,"Server responded with status "+h.getStatus()))}else u(new L(C.UNAVAILABLE,"Connection failed."));break;default:x()}}finally{D(Ee,`RPC '${e}' ${o} completed.`)}}));const d=JSON.stringify(i);D(Ee,`RPC '${e}' ${o} sending request:`,i),h.send(t,"POST",d,r,15)}))}Bo(e,t,r){const i=ts(),o=[this.Do,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=Bu(),u=Uu(),h={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(h.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(h.useFetchStreams=!0),this.Oo(h.initMessageHeaders,t,r),h.encodeInitMessageHeaders=!0;const p=o.join("");D(Ee,`Creating RPC '${e}' stream ${i}: ${p}`,h);const I=a.createWebChannel(p,h);let A=!1,P=!1;const V=new J_({Io:k=>{P?D(Ee,`Not sending because RPC '${e}' stream ${i} is closed:`,k):(A||(D(Ee,`Opening RPC '${e}' stream ${i} transport.`),I.open(),A=!0),D(Ee,`RPC '${e}' stream ${i} sending:`,k),I.send(k))},To:()=>I.close()}),O=(k,W,H)=>{k.listen(W,(K=>{try{H(K)}catch(te){setTimeout((()=>{throw te}),0)}}))};return O(I,Nn.EventType.OPEN,(()=>{P||(D(Ee,`RPC '${e}' stream ${i} transport opened.`),V.yo())})),O(I,Nn.EventType.CLOSE,(()=>{P||(P=!0,D(Ee,`RPC '${e}' stream ${i} transport closed`),V.So())})),O(I,Nn.EventType.ERROR,(k=>{P||(P=!0,Yt(Ee,`RPC '${e}' stream ${i} transport errored:`,k),V.So(new L(C.UNAVAILABLE,"The operation could not be completed")))})),O(I,Nn.EventType.MESSAGE,(k=>{var W;if(!P){const H=k.data[0];G(!!H);const K=H,te=K.error||((W=K[0])===null||W===void 0?void 0:W.error);if(te){D(Ee,`RPC '${e}' stream ${i} received error:`,te);const Ne=te.status;let ne=(function(_){const y=ie[_];if(y!==void 0)return ll(y)})(Ne),v=te.message;ne===void 0&&(ne=C.INTERNAL,v="Unknown error status: "+Ne+" with message "+te.message),P=!0,V.So(new L(ne,v)),I.close()}else D(Ee,`RPC '${e}' stream ${i} received:`,H),V.bo(H)}})),O(u,Fu.STAT_EVENT,(k=>{k.stat===ds.PROXY?D(Ee,`RPC '${e}' stream ${i} detected buffering proxy`):k.stat===ds.NOPROXY&&D(Ee,`RPC '${e}' stream ${i} detected no buffering proxy`)})),setTimeout((()=>{V.wo()}),0),V}}function ns(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
