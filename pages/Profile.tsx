...
const Profile: React.FC = () => {
  ...
  const profileLoadingMessages = [
    ...
    'Fetching regional mastery...',
    'Preparing dashboard...',
    'Syncing progress...',
    'Finalizing profile...',
  ];

  const profileReady = !userLoading && !authLoading;
      ...
      {!showProfile ? (
        ...
        >
          <div className="min-h-screen bg-surface-dark relative flex items-center justify-center px-4 pt-28 pb-12 overflow-hidden">
            <SEO title="Loading Profile" description="Preparing your ExploreCapitals profile." />
            ...
            <div className="relative z-10 w-full max-w-lg flex flex-col items-center">
              ...
              <div className="w-full bg-black/40 backdrop-blur-3xl rounded-[2.5rem] p-8 md:p-12 text-center border border-white/10 relative overflow-hidden">
                ...
                <div className="mb-8 relative pt-4">
                  ...
                  <div className="relative z-10 w-24 h-24 mx-auto mb-4 rounded-full bg-white/5 border-2 border-sky/30 flex items-center justify-center overflow-hidden animate-float-slow">
                    <Globe size={40} className="text-sky/60" />
                  </div>
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 border border-sky/10 rounded-full animate-spin-slow opacity-20" />
                </div>
                ...
                <div className="space-y-4 mb-10">
                  <div className="inline-flex items-center gap-3 px-5 py-2 bg-sky/10 rounded-full border border-white/10 mb-2 shadow-inner">
                    ...
                    <span className="text-[10px] font-black text-sky-light uppercase tracking-[0.5em]">
                      {loadingProgress < 100 ? 'Synchronizing Profile' : 'Profile Ready'}
                    </span>
                  </div>

                  <div className="flex flex-col items-center">
                    <span className="text-[10px] text-white/40 tracking-[0.4em] uppercase mb-1 font-black">Explorer</span>
                    <h1 className="text-2xl md:text-4xl font-display font-black text-white tracking-tighter uppercase leading-tight">
                      {authUser?.displayName || user?.name || 'Profile'}
                    </h1>
                  </div>
                </div>
                ...
                <div className="h-5 mb-2">
                  <AnimatePresence mode="wait">
                    ...
                    >
                      {profileLoadingMessages[loadingStep]}
                    </motion.p>
                  </AnimatePresence>
                </div>
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-x-6 gap-y-1 justify-center opacity-30">
                <span className="text-[8px] font-mono text-white/60 tracking-wider">
                  USER: {authUser?.email || 'authenticated'}
                </span>
                <span className="text-[8px] font-mono text-white/60 tracking-wider">
                  STATUS: {loadingProgress < 100 ? 'SYNCING' : 'READY'}
                </span>
              </div>
            </div>
          </div>
