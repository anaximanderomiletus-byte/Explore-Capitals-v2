          ...
          >
            ...
            <div className="max-w-2xl mx-auto w-full flex shrink-0 items-center justify-between md:justify-between mb-3 md:mb-4 bg-white/10 backdrop-blur-2xl p-2.5 md:p-3 rounded-2xl shadow-glass border border-white/20 relative overflow-hidden z-10">
               ...
               <div className="absolute left-1/2 -translate-x-1/2 flex flex-col items-center pointer-events-none">
                  <h1 className="text-[10px] font-black text-white uppercase tracking-[0.2em] md:tracking-[0.3em] drop-shadow-md whitespace-nowrap">Flag Frenzy</h1>
            ...
            <div className="flex-1 max-w-2xl mx-auto w-full flex flex-col min-h-0 bg-white/10 backdrop-blur-3xl rounded-2xl md:rounded-3xl border border-white/30 p-4 md:p-8 overflow-hidden relative shadow-glass z-10">
