      ...
      <AnimatePresence mode="wait">
        ...
        {gameState === 'playing' && currentQuestion && (
          ...
          >
            ...
            <div className="game-bubble flex-1 max-w-2xl mx-auto w-full flex flex-col min-h-0 bg-white/10 backdrop-blur-3xl rounded-2xl rounded-3xl border-white/30 overflow-hidden relative z-10">
