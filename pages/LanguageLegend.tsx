...
export default function LanguageLegend() {
  ...
  const generateQuestion = useCallback(() => {
    ...
    // Get 3 random different languages as distractors
    const distractors = allLanguages
      .filter(lang => !country.languages.includes(lang))
  ...
  const handleAnswer = (answer: string) => {
    ...
    // An answer is correct if it's one of the country's official languages
    const isCorrect = currentQuestion.country.languages.includes(answer);
    ...
    <div className="h-[100dvh] min-h-screen bg-surface-dark font-sans relative overflow-hidden">
      <AnimatePresence mode="wait">
        {gameState === 'start' && (
          ...
          >
            ...
            <div className="max-w-md w-full bg-white/20 backdrop-blur-3xl rounded-3xl p-8 text-center border-2 border-white/40 relative z-10 overflow-hidden group">
              ...
              <div className="w-20 h-20 bg-secondary rounded-full flex items-center justify-center mx-auto mb-8 text-white border border-white/40 relative overflow-hidden transition-transform duration-700">
                <Languages size={36} className="relative z-10 drop-shadow-lg" />
              </div>
              <h1 className="text-4xl font-display font-black text-white mb-2 uppercase tracking-tighter drop-shadow-md">Language Legend</h1>
              <p className="text-white/70 text-[10px] mb-10 font-bold uppercase tracking-[0.2em] leading-relaxed">Match countries to their languages.</p>
        ...
        {gameState === 'playing' && currentQuestion && (
          ...
          >
            <SEO title="Language Legend - Playing" description="Identify countries by their official languages." />
            ...
            <div className="max-w-2xl mx-auto w-full flex shrink-0 items-center gap-2 mb-3 md:mb-4 bg-white/10 backdrop-blur-2xl p-2.5 md:p-3 rounded-2xl border border-white/20 z-10">
              ...
              <div className="flex-1 flex flex-col items-center justify-center min-w-0">
                <h1 className="text-[9px] sm:text-[10px] font-black text-white uppercase tracking-[0.15em] sm:tracking-[0.3em] drop-shadow-md truncate max-w-full text-center">Language Legend</h1>
                <div className="h-0.5 w-6 bg-secondary/40 rounded-full mt-1" />
              </div>
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <div className="flex flex-col items-center justify-center flex-1 min-h-0 pt-0 pb-6 md:pt-4 md:pb-16 overflow-hidden relative z-10">
                    <p className="text-secondary font-black text-[9px] uppercase tracking-[0.4em] mb-1 md:mb-1 font-sans opacity-80">IDENTIFY LANGUAGE</p>
