      ...
      <AnimatePresence mode="wait">
        {gameState === 'start' && (
          ...
          >
            ...
            <div className="fixed inset-0 z-0 pointer-events-none">
              <div className="absolute top-[-20%] left-[-10%] w-[100%] h-[100%] bg-secondary/20 rounded-full blur-[150px] opacity-60" />
            ...
            <div className="max-w-md w-full bg-white/10 backdrop-blur-3xl rounded-3xl p-8 text-center border-2 border-white/20 relative z-10">
              ...
              <div className="w-20 h-20 bg-secondary/20 rounded-2xl flex items-center justify-center mx-auto mb-8 text-secondary border border-white/30">
                <Languages size={36} />
              </div>
              <h1 className="text-4xl font-display font-black text-white mb-2 uppercase tracking-tighter">Language Legend</h1>
              <p className="text-white/40 text-[10px] mb-10 font-bold uppercase tracking-[0.2em]">Match countries to their languages.</p>
        ...
        {gameState === 'playing' && currentQuestion && (
          ...
          >
            ...
            <div className="fixed inset-0 z-0 pointer-events-none">
              <div className="absolute top-[10%] right-[10%] w-[60%] h-[60%] bg-secondary/10 rounded-full blur-[100px]" />
            ...
            <div className="max-w-3xl mx-auto w-full flex shrink-0 items-center gap-2 mb-3 md:mb-4 bg-white/10 backdrop-blur-2xl p-2.5 md:p-3 rounded-2xl border border-white/20 z-10">
              ...
              <div className="flex-1 flex flex-col items-center justify-center min-w-0">
                <h1 className="text-[9px] sm:text-[10px] font-black text-white uppercase tracking-[0.15em] sm:tracking-[0.3em] truncate">Language Legend</h1>
            ...
            <div className="flex-1 max-w-3xl mx-auto w-full flex flex-col min-h-0 bg-white/10 backdrop-blur-3xl rounded-2xl md:rounded-3xl border border-white/20 overflow-hidden relative z-10 p-4 md:p-6">
              ...
              <div className="flex-1 flex flex-col items-center justify-center">
                <div className="mb-6 text-center">
                  ...
                  <p className="text-secondary text-sm font-bold uppercase tracking-[0.2em] flex items-center justify-center gap-2">
                    <Languages size={16} /> What is an official language?
                  </p>
                </div>
