        ...
        {gameState === 'start' && (
          ...
          >
            ...
            <div className="game-lobby-card w-full bg-white/20 backdrop-blur-3xl rounded-3xl p-5 sm:p-8 text-center border-2 border-white/40 overflow-hidden group">
              ...
              <h2 className="text-4xl font-display font-black text-white mb-2 uppercase tracking-tighter drop-shadow-md">Time Zone Trekker</h2>
                  ...
                  <div className="game-options-grid grid grid-cols-1 md:grid-cols-2 gap-1.5 sm:gap-2 md:gap-2.5 shrink-0 pb-2 md:pb-4 relative z-10">
                    {currentQuestion.options.map((option, idx) => {
                      ...
                      if (selectedAnswer) {
                        ...
                        else if (option === currentQuestion.country.timeZone) stateStyles = "bg-accent/40 border-2 border-accent/80 text-white";
