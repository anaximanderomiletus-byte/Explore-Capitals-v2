      ...
      <AnimatePresence mode="wait">
        {gameState === 'start' && (
          ...
          >
            ...
            <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Games', href: '/games/all' }, { label: 'Region Roundup' }]} />
                   ...
                   <div className="game-options-grid grid grid-cols-1 md:grid-cols-2 gap-1.5 sm:gap-2 md:gap-2.5 shrink-0 pb-2 md:pb-4 relative z-10">
                      {regionOptions.map((region) => {
                        ...
                        if (selectedAnswer) {
                          ...
                          else if (region === currentCountry.region) stateStyles = "bg-accent/40 border-2 border-accent/80 text-white";
