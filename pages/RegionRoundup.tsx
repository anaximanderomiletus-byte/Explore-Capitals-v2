...
export default function RegionRoundup() {
  ...
  const setupQuestion = (target: Country) => {
    ...
    const distractors = shuffle(
      REGIONS.filter((r) => r !== correctRegion),
    ).slice(0, 3);
  ...
  return (
    <div className="h-screen h-[100svh] bg-surface font-sans relative overflow-hidden">
      <div className="absolute inset-0 z-0 pointer-events-none">
        <img
          src={`${import.meta.env.BASE_URL}png/GAMES/region-roundup.png`}
          alt=""
          ...
          >
            <SEO
              ...
              structuredData={getGameStructuredData({
                ...
                slug: "region-roundup",
                description:
                  "Sort countries by continent. Test if you know which countries belong to Africa, Asia, Europe, and other regions of the world.",
                    ...
                    <div className="game-options-grid grid grid-cols-1 md:grid-cols-2 gap-1.5 sm:gap-2 md:gap-2.5 shrink-0 pb-2 md:pb-4 relative z-10">
                      {regionOptions.map((region) => {
                        ...
                        if (selectedAnswer) {
                          ...
                          else if (region === currentCountry.region)
                            stateStyles =
