...
export default function CapitalConnection() {
  ...
  const handleCardClick = useCallback((cardId: string) => {
    ...
    <div className="h-screen h-[100svh] bg-surface-dark font-sans relative overflow-hidden">
      ...
      <div className="game-bubble flex-1 max-w-3xl mx-auto w-full flex flex-col min-h-0 bg-white/5 backdrop-blur-xl overflow-hidden relative z-10 rounded-[32px] border-2 border-white/20">
