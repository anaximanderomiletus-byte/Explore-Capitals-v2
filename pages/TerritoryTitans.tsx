        ...
        {gameState === 'start' && (
          ...
          >
            ...
            <div className="max-w-md w-full bg-white/20 backdrop-blur-3xl rounded-3xl p-8 text-center border-2 border-white/40 relative z-10 overflow-hidden group">
              ...
              <p className="text-white/70 text-[10px] mb-10 font-bold uppercase tracking-[0.2em] leading-relaxed">Master territories & dependencies.</p>
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <div className="flex flex-col items-center justify-center flex-1 min-h-0 pt-0 pb-6 md:pt-4 md:pb-16 overflow-hidden relative z-10">
                    <p className="text-accent font-black text-[9px] uppercase tracking-[0.4em] mb-1 md:mb-1 font-sans opacity-80">
                    ...
                    <img 
                      src={`https://flagcdn.com/w320/${getCountryCode(currentQuestion.territory.flag)}.png`}
