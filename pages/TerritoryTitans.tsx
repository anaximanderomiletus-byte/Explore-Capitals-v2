          ...
          >
            <SEO
              ...
              structuredData={getGameStructuredData({
                ...
                description: 'Master autonomous regions and dependencies worldwide. A premium geography game.',
                image: '/png/GAMES/territory-titans.png',
              })}
            />

            {/* Background Decor */}
            <div className="fixed inset-0 z-0 pointer-events-none">
              <div className="absolute top-[-20%] left-[-10%] w-[100%] h-[100%] bg-accent/15 rounded-full blur-3xl opacity-80" />
              <div className="absolute bottom-[-10%] right-[-10%] w-[80%] h-[80%] bg-accent/5 rounded-full blur-3xl opacity-60" />
            </div>
          ...
          >
            ...
            <div className="game-top-bar max-w-2xl mx-auto w-full flex shrink-0 items-center gap-2 mb-2 md:mb-4 bg-white/10 backdrop-blur-2xl p-2 md:p-3 rounded-2xl border border-white/20 z-10">
              ...
              <div className="flex-1 flex flex-col items-center justify-center min-w-0">
                <h2 className="text-[9px] sm:text-[10px] font-black text-white uppercase tracking-[0.15em] sm:tracking-[0.3em] drop-shadow-md truncate max-w-full text-center">Territory Titans</h2>
                  ...
                  <div className="game-options-grid grid grid-cols-1 md:grid-cols-2 gap-1.5 sm:gap-2 md:gap-2.5 shrink-0 pb-2 md:pb-4 relative z-10">
                    {currentQuestion.options.map((option, idx) => {
                      ...
                      if (selectedAnswer) {
                        ...
                        else if (option === correctAnswer) stateStyles = "bg-accent/40 border-2 border-accent/80 text-white";
