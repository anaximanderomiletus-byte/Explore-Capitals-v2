  ...
  return (
    <div className="h-screen h-[100svh] bg-surface font-sans relative overflow-hidden">
      <div className="absolute inset-0 z-0 pointer-events-none">
        <img
          src={`${import.meta.env.BASE_URL}png/GAMES/currency-craze.png`}
          alt=""
          ...
          >
            <SEO
              ...
              structuredData={getGameStructuredData({
                ...
                slug: "currency-craze",
                description:
                  "Match countries to their official currencies. A premium geography game.",
                  ...
                  >
                    ...
                    <div className="game-options-grid grid grid-cols-1 md:grid-cols-2 gap-1.5 sm:gap-2 md:gap-2.5 shrink-0 pb-2 md:pb-4 relative z-10">
                      {currentQuestion.options.map((option, idx) => {
                        ...
                        const isCorrect =
                          option === currentQuestion.country.currency;
                        ...
                        if (selectedAnswer) {
                          ...
                          else if (option === currentQuestion.country.currency)
                            stateStyles =
