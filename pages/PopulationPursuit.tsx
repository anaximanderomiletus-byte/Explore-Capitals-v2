    ...
    <div className="h-screen h-[100svh] bg-surface-dark font-sans relative overflow-hidden">
      ...
      <AnimatePresence mode="wait">
        {gameState === 'start' && (
          ...
          >
        <SEO
          title="Population Pursuit - Games"
          description="Which country has more people? Compare populations and test your knowledge of world demographics in this geography game."
          structuredData={getGameStructuredData({
            name: 'Population Pursuit',
            slug: 'population-pursuit',
            description: 'Which country has more people? Compare populations and test your knowledge of world demographics in this geography game.',
        ...
        <div className="fixed inset-0 z-0 pointer-events-none">
          ...
          <h1 className="text-4xl sm:text-5xl font-display font-black text-white mb-2 uppercase tracking-tighter drop-shadow-md">Population Pursuit</h1>
          <p className="text-white/70 text-[10px] mb-6 font-bold uppercase tracking-[0.2em] leading-relaxed h-8 sm:h-auto flex items-center justify-center">Choose the larger population.</p>
