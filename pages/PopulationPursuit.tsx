  ...
  const generateRound = useCallback(() => {
    ...
    const preloadFlags = () => {
      const nextIdx1 = Math.floor(
        Math.random() * countriesWithNumericPop.length,
      );
  ...
  return (
    <div className="h-screen h-[100svh] bg-surface font-sans relative overflow-hidden">
      <div className="absolute inset-0 z-0 pointer-events-none">
        <img
          src={`${import.meta.env.BASE_URL}png/GAMES/population-pursuit.png`}
          alt=""
          ...
          >
            <SEO
              ...
              structuredData={getGameStructuredData({
                ...
                description:
                  "Which country has more people? Compare populations and test your knowledge of world demographics in this geography game.",
