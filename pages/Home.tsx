...
// Simple section wrapper - no heavy effects
...
// CSS-only fade-in animation component (no JS needed)
...
const Home: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Mark as ready after a brief moment to allow initial render
  ...
  return (
    <main className={`relative flex-grow bg-[#0F172A] overflow-x-hidden max-w-[100vw] w-full ${isReady ? 'opacity-100' : 'opacity-0'}`} style={{ transition: 'opacity 0.15s ease-out' }}>
      <SEO
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(0,194,255,0.06)_0%,transparent_50%)]" />
      </div>
      ...
      <Section className="min-h-[100svh] flex items-center justify-center">
        <div className="max-w-7xl mx-auto flex flex-col lg:grid lg:grid-cols-2 gap-2 sm:gap-3 lg:gap-x-16 lg:gap-y-5 items-center pt-8 sm:pt-12 lg:pt-20">
          {/* Badge */}
          <FadeIn delay={0} className="text-center lg:text-left lg:col-start-1">
            <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-white/5 border-2 border-white/30 rounded-full text-[8px] sm:text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] sm:tracking-[0.3em] text-white">
          ...
          {/* Heading */}
          <FadeIn delay={50} className="text-center lg:text-left lg:col-start-1">
          ...
          {/* Globe */}
          <FadeIn delay={100} className="relative lg:col-start-2 lg:row-start-1 lg:row-span-5 flex justify-center items-center my-1 sm:my-2 lg:my-0">
            {/* Static glow - no blur */}
            <div 
            ...
            <div className="relative w-48 h-48 sm:w-64 sm:h-64 md:w-72 md:h-72 lg:w-[540px] lg:h-[540px] flex-shrink-0">
              <Link to="/map" className="w-full h-full bg-white/5 rounded-full border-2 border-white/40 flex items-center justify-center overflow-hidden cursor-pointer">
                <img 
              ...
              {/* Static decorative bubbles - no animations */}
              <div className="absolute -top-1 -right-1 sm:-top-2 sm:-right-2 md:top-2 md:right-2 z-10 pointer-events-none">
                <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-20 md:h-20 lg:w-28 lg:h-28 bg-sky/10 border border-sky/30 rounded-full flex items-center justify-center">
              ...
              <div className="absolute -bottom-1 -left-2 sm:-bottom-2 sm:-left-4 md:bottom-2 md:-left-8 lg:-left-12 z-10 pointer-events-none">
                <div className="w-14 h-14 sm:w-16 sm:h-16 md:w-24 md:h-24 lg:w-36 lg:h-36 bg-sky/10 border border-sky/30 rounded-full flex items-center justify-center">
          ...
          {/* Description */}
          <FadeIn delay={150} className="text-center lg:text-left lg:col-start-1 lg:-mt-1 lg:mb-4">
          ...
          {/* Button */}
          <FadeIn delay={200} className="text-center lg:text-left lg:col-start-1 mt-4 sm:mt-6 lg:mt-0">
            <Link to="/games">
      ...
      <Section>
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row items-center sm:items-end justify-between mb-6 sm:mb-8 md:mb-12 gap-4 sm:gap-6 text-center sm:text-left">
            ...
            <Link to="/games">
              <Button variant="secondary" size="md" className="px-6 sm:px-8 h-10 sm:h-12 text-xs sm:text-sm uppercase bg-white/5 border-white/10 hover:bg-white/10">
                All Games
              </Button>
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-5 md:gap-6 lg:gap-8">
            <GameCard title="Capital Quiz" desc="Recall test of world capitals." icon={<GraduationCap size={28} />} color="bg-gel-blue" link="/games/capital-quiz" stats="12.4k Played" />
            <GameCard title="Map Dash" desc="Find nations on the map." icon={<Globe2 size={28} />} color="bg-sky" link="/games/map-dash" stats="8.1k Played" />
            <GameCard title="Flag Frenzy" desc="Identify global flags." icon={<Trophy size={28} />} color="bg-accent" link="/games/flag-frenzy" stats="15.2k Played" />
          </div>
        </div>
      </Section>
      ...
      <Section>
        <div className="max-w-7xl mx-auto">
          <div className="bg-white/[0.03] border border-white/10 rounded-2xl sm:rounded-[2.5rem] md:rounded-[4rem] p-5 sm:p-8 md:p-12 lg:p-20 overflow-hidden relative">
            <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-16 items-center relative z-10">
              ...
              <div className="relative">
                <div className="bg-white/5 border border-white/10 p-4 sm:p-6 md:p-10 rounded-xl sm:rounded-2xl md:rounded-[3rem]">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 md:gap-8 lg:gap-10">
            <Link to="/database" className="group">
              <div className="h-full p-5 sm:p-6 md:p-12 bg-white/[0.03] border border-white/10 rounded-2xl sm:rounded-[2rem] md:rounded-[3rem] flex flex-col items-center text-center hover:bg-white/[0.06] transition-colors">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 md:gap-8 px-2">
            ...
            <Link to="/auth" className="w-full sm:w-auto">
              <Button variant="secondary" size="lg" className="w-full sm:w-44 md:w-56 h-12 sm:h-14 md:h-20 text-base sm:text-lg md:text-xl uppercase bg-white/5 border-2 border-white/10 hover:bg-white/10">
                Sign Up
              </Button>
            </Link>
            )}
...
// Simplified GameCard - no heavy effects
const GameCard: React.FC<{ title: string; desc: string; icon: React.ReactNode; color: string; link: string; stats: string }> = ({
  title, desc, icon, color, link, stats,
}) => (
  <Link to={link} className="group block h-full">
    <div className="h-full bg-white/[0.06] rounded-2xl sm:rounded-[2rem] lg:rounded-[3rem] border border-white/20 hover:bg-white/[0.1] hover:border-white/30 transition-colors p-5 sm:p-6 md:p-8 lg:p-12 flex flex-col">
      <div className={`w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 lg:w-20 lg:h-20 ${color} rounded-xl sm:rounded-2xl flex items-center justify-center text-white mb-4 sm:mb-6 md:mb-8 lg:mb-10 border border-white/20`}>
