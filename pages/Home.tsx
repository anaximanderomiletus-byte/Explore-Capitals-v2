...
const Home: React.FC = () => {
  ...
  return (
    <main className="relative flex-grow bg-[#0F172A] overflow-x-hidden max-w-[100vw] w-full">
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:grid lg:grid-cols-2 gap-2 sm:gap-3 lg:gap-x-16 lg:gap-y-5 items-center pt-8 sm:pt-12 lg:pt-20">
          ...
          >
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-[5.5rem] xl:text-[7rem] font-display font-black text-white tracking-tighter leading-[1.05] uppercase drop-shadow-2xl overflow-visible">
              Play Your <br />
              <span className="bg-clip-text bg-gel-blue [-webkit-text-fill-color:transparent] drop-shadow-glow-sky overflow-visible" style={{ paddingBottom: '0.15em', paddingRight: '0.1em', display: 'inline-block' }}>
                Atlas.
              </span>
            </h1>
          </motion.div>
          ...
          >
            ...
            <div className="relative w-48 h-48 sm:w-64 sm:h-64 md:w-72 md:h-72 lg:w-[540px] lg:h-[540px] flex-shrink-0 pointer-events-none">
              ...
              >
                <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-20 md:h-20 lg:w-28 lg:h-28 aspect-square bg-sky/15 backdrop-blur-2xl border border-sky/30 rounded-full shadow-glass-bubble flex items-center justify-center">
              ...
              >
                <div className="w-14 h-14 sm:w-16 sm:h-16 md:w-24 md:h-24 lg:w-36 lg:h-36 aspect-square bg-sky/15 backdrop-blur-2xl border border-sky/30 rounded-full shadow-glass-bubble flex items-center justify-center">
          ...
          >
            <Link to="/games">
              <Button variant="primary" size="lg" className="w-64 sm:w-72 md:w-80 h-14 sm:h-16 md:h-18 text-xl sm:text-2xl group uppercase shadow-glow-sky">
      ...
      <ParallaxSection>
        <div className="max-w-7xl mx-auto">
          <div className="bg-white/[0.02] backdrop-blur-3xl border border-white/10 rounded-2xl sm:rounded-[2.5rem] md:rounded-[4rem] p-5 sm:p-8 md:p-12 lg:p-20 overflow-hidden relative group shadow-glass-bubble">
            ...
            <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-16 items-center relative z-10">
              <div className="text-center lg:text-left">
                <div className="inline-flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-1 sm:py-1.5 bg-sky/10 border border-white/10 rounded-full text-[8px] sm:text-[9px] md:text-[10px] font-black text-sky-light uppercase tracking-[0.2em] sm:tracking-[0.3em] mb-4 sm:mb-6 md:mb-8 shadow-glow-sky">
                ...
                <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-display font-black text-white mb-3 sm:mb-4 md:mb-8 leading-[0.95] tracking-tighter uppercase">
                  Learn. <br />
                  <span className="bg-clip-text bg-gel-blue [-webkit-text-fill-color:transparent] drop-shadow-glow-sky">Earn Rewards.</span>
                </h2>
                ...
                <Link to="/loyalty">
                  <Button variant="primary" size="lg" className="h-11 sm:h-14 md:h-16 px-8 sm:px-10 md:px-12 text-base sm:text-lg uppercase shadow-glow-sky">
                    View Ranks
                  </Button>
                </Link>
              </div>
              ...
              <div className="relative">
                <div className="bg-white/5 backdrop-blur-3xl border border-white/10 p-4 sm:p-6 md:p-10 rounded-xl sm:rounded-2xl md:rounded-[3rem] shadow-glass-bubble transform transition-all duration-700">
                  <div className="flex items-center gap-3 sm:gap-4 md:gap-6 mb-4 sm:mb-6 md:mb-10">
                    <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-20 md:h-20 bg-gel-blue rounded-lg sm:rounded-xl md:rounded-2xl flex items-center justify-center text-white shadow-glow-sky border border-white/20 relative overflow-hidden flex-shrink-0">
                  ...
                  <div className="space-y-4 sm:space-y-6 md:space-y-10">
                    <div>
                      <div className="flex justify-between items-end mb-2 sm:mb-3 md:mb-4">
                        ...
                        <span className="text-base sm:text-lg md:text-xl font-black text-sky drop-shadow-glow-sky">75%</span>
                      </div>
                      <div className="h-2.5 sm:h-3 md:h-4 w-full bg-black/20 rounded-full overflow-hidden p-0.5 border border-white/5">
                        <motion.div 
                          ...
                          className="h-full bg-frutiger-gradient rounded-full shadow-glow-sky relative"
                        >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 md:gap-8 lg:gap-10">
            <Link to="/database" className="group">
              <div className="h-full p-5 sm:p-6 md:p-12 bg-white/[0.03] backdrop-blur-3xl border border-white/10 rounded-2xl sm:rounded-[2rem] md:rounded-[3rem] flex flex-col items-center text-center transition-all duration-500 hover:bg-white/[0.08] shadow-glass-bubble relative overflow-hidden">
                <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-20 md:h-20 bg-gel-blue rounded-full flex items-center justify-center text-white mb-4 sm:mb-6 md:mb-10 shadow-glow-sky border border-white/20 relative z-10">
            ...
            <Link to="/map" className="group">
              <div className="h-full p-5 sm:p-6 md:p-12 bg-white/[0.03] backdrop-blur-3xl border border-white/10 rounded-2xl sm:rounded-[2rem] md:rounded-[3rem] flex flex-col items-center text-center transition-all duration-500 hover:bg-white/[0.08] shadow-glass-bubble relative overflow-hidden">
                <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-20 md:h-20 bg-accent rounded-lg sm:rounded-xl md:rounded-2xl flex items-center justify-center text-white mb-4 sm:mb-6 md:mb-10 shadow-glow-accent border border-white/20 relative z-10">
      ...
      >
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl md:text-6xl lg:text-8xl font-display font-black text-white mb-3 sm:mb-6 md:mb-10 tracking-tighter uppercase leading-[0.9] drop-shadow-[0_10px_30px_rgba(0,0,0,0.5)]">
            Start Your <br />
            <span className="bg-clip-text bg-gel-blue [-webkit-text-fill-color:transparent] drop-shadow-[0_0_40px_rgba(0,194,255,0.6)]">
              Expedition.
            </span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 md:gap-8 px-2">
            <Link to="/games" className="w-full sm:w-auto group/btn">
              <Button variant="primary" size="lg" className="w-full sm:w-56 md:w-72 h-12 sm:h-14 md:h-20 text-lg sm:text-xl md:text-2xl uppercase shadow-glow-sky border-2 border-white/30 transition-all">
                Play Now
              </Button>
            </Link>
...
const GameCard: React.FC<{ title: string; desc: string; icon: React.ReactNode; color: string; link: string; stats: string }> = ({
  ...
  <Link to={link} className="group block h-full relative">
    ...
    <div className={`absolute inset-0 bg-white/10 backdrop-blur-2xl rounded-2xl sm:rounded-[2rem] lg:rounded-[3rem] border-2 border-white/40 transition-all duration-700 ease-out group-hover:bg-white/15 group-hover:border-white/60 shadow-glass-bubble overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.2)]`}>
    ...
    <div className="relative p-5 sm:p-6 md:p-8 lg:p-12 flex flex-col h-full z-10">
      <div className={`w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 lg:w-20 lg:h-20 ${color} rounded-xl sm:rounded-2xl flex items-center justify-center text-white mb-4 sm:mb-6 md:mb-8 lg:mb-10 shadow-glass-bubble transition-all duration-700 ease-out relative overflow-hidden border-2 border-white/40`}>
