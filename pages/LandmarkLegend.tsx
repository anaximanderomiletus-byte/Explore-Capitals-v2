        ...
        {gameState === 'start' && (
          ...
          >
            ...
            <div className="game-lobby-card w-full bg-white/20 backdrop-blur-3xl rounded-2xl p-8 sm:p-12 text-center border-2 border-white/40 overflow-hidden group relative">
                ...
                <h1 className="text-4xl sm:text-5xl font-display font-black text-white mb-2 uppercase tracking-tighter drop-shadow-md">Landmark Legend</h1>
                <p className="text-white/70 text-[10px] mb-6 font-bold uppercase tracking-[0.2em] leading-relaxed h-8 sm:h-auto flex items-center justify-center">Identify nations through their landmarks.</p>
                   ...
                   <div className="game-options-grid grid grid-cols-1 md:grid-cols-2 gap-1.5 sm:gap-2 md:gap-2.5 shrink-0 pb-2 md:pb-4 relative z-10">
                      {currentQuestion.options.map((option) => {
                        ...
                        if (selectedAnswerId) {
                          ...
                          else if (option.id === currentQuestion.country.id) stateStyles = "bg-accent/40 border-2 border-accent/80 text-white";
