...
export default function GlobalDetective() {
  ...
  return (
    <div className="h-screen h-[100svh] w-full relative overflow-hidden font-sans bg-surface-dark">
      ...
      {gameState === 'playing' && targetCountry && (
          ...
          <div className="game-bubble flex-1 mx-auto w-full flex flex-col min-h-0 bg-white/15 backdrop-blur-3xl overflow-hidden relative z-10 rounded-[32px] border-2 border-white/20">
  <div className="game-top-bar w-full flex shrink-0 items-center justify-between px-4 py-3 md:px-6 md:py-4 border-b border-white/10 z-20">
    ...
    <div className="flex-1 flex flex-col items-center justify-center min-w-0">
      <h2 className="text-[12px] sm:text-[14px] md:text-[16px] font-black text-white uppercase tracking-[0.15em] sm:tracking-[0.3em] drop-shadow-md truncate max-w-full text-center">Global Detective</h2>
    </div>
                ...
                <div className="game-score-bar flex items-center justify-between gap-2 mb-1.5 sm:mb-2 md:mb-4 relative z-20 shrink-0">
                   ...
                   <div className={`flex items-center gap-1.5 sm:gap-2 px-2 sm:px-2.5 py-1 md:px-3 md:py-1.5 rounded-xl shadow-inner transition-all duration-300 relative shrink-0 ${timeLeft < 10 ? 'bg-red-500/10 border-2 border-error animate-timer-panic' : 'bg-sky/25 text-white border-2 border-white/30'}`}>
                    ...
                    <div className="game-content flex flex-col flex-1 justify-center">
                        <h2 className="text-sky-light font-black uppercase tracking-[0.4em] text-[9px] mb-1.5 sm:mb-2 md:mb-3 flex items-center gap-2 font-sans">
