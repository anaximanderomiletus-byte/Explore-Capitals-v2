...
export default function CapitalQuiz() {
    ...
    <div className="h-screen h-[100svh] bg-surface-dark font-sans relative overflow-hidden">
      ...
      <AnimatePresence mode="wait">
        ...
        <div className="fixed inset-0 z-0 pointer-events-none">
          ...
          <p className="text-white/70 text-[10px] mb-6 font-bold uppercase tracking-[0.2em] leading-relaxed h-8 sm:h-auto flex items-center justify-center">Identify world capitals. Speed is vital.</p>
  ...
  <div className="game-top-bar w-full flex shrink-0 items-center justify-between px-4 py-3 md:px-6 md:py-4 border-b border-white/10 z-20">
    ...
    <div className="flex-1 flex flex-col items-center justify-center min-w-0">
      <h2 className="text-[12px] sm:text-[14px] md:text-[16px] font-black text-white uppercase tracking-[0.15em] sm:tracking-[0.3em] drop-shadow-md truncate max-w-full text-center">Capital Quiz</h2>
    </div>
            ...
            {currentQuestion.options.map((option) => {
              ...
              const isWrong = isSelected && !isCorrect;
                              ...
                              if (selectedAnswer) {
                                ...
                                else if (option.capital === currentQuestion.country.capital) stateStyles = "bg-accent/40 border-2 border-accent/80 text-white shadow-[0_0_15px_rgba(34,197,94,0.2)]";
