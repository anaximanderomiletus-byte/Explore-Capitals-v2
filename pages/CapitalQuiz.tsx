  ...
  useEffect(() => {
    ...
    <div className="h-[100dvh] min-h-screen bg-surface-dark font-sans relative overflow-hidden">
      <div className="absolute inset-0 z-0 pointer-events-none">
        <img src={`${import.meta.env.BASE_URL}png/0-GAMES/capital-quiz.png`} alt="" className="w-full h-full object-cover opacity-10 blur-sm" />
      </div>
      <AnimatePresence mode="wait">
        ...
        <div className="fixed inset-0 z-0 pointer-events-none">
          ...
          <div className="w-20 h-20 rounded-2xl mx-auto mb-8 border border-white/30 relative overflow-hidden">
            <img src={`${import.meta.env.BASE_URL}png/0-GAMES/capital-quiz.png`} alt="Capital Quiz" className="w-full h-full object-cover" />
          </div>
      ...
      {/* Background Decor */}
      <div className="fixed inset-0 z-0 pointer-events-none">
        <div className="absolute top-[10%] right-[10%] w-[60%] h-[60%] bg-sky/10 rounded-full blur-[120px] opacity-60" />
          ...
          >
            ...
            <div className="w-full bg-white/20 backdrop-blur-3xl rounded-3xl p-5 sm:p-8 text-center border-2 border-white/40 overflow-hidden group">
              <div className="w-20 h-20 bg-warning/30 rounded-full flex items-center justify-center mx-auto mb-6 text-warning border border-white/40 relative overflow-hidden">
                <Trophy size={28} className="sm:!w-9 sm:!h-9 relative z-10 drop-shadow-lg" />
              </div>
