    ...
    <div className="h-screen h-[100svh] bg-surface-dark font-sans relative overflow-hidden">
      ...
      <AnimatePresence mode="wait">
        ...
        <div className="fixed inset-0 z-0 pointer-events-none">
          ...
          <p className="text-white/70 text-[10px] mb-6 font-bold uppercase tracking-[0.2em] leading-relaxed h-8 sm:h-auto flex items-center justify-center">Identify world capitals.</p>
