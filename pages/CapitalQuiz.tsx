  ...
  return (
    <div className="h-screen h-[100svh] bg-surface font-sans relative overflow-hidden">
      <div className="absolute inset-0 z-0 pointer-events-none">
        <img
          src={`${import.meta.env.BASE_URL}png/GAMES/capital-quiz.png`}
          alt=""
          ...
          >
            <SEO
              ...
              structuredData={getGameStructuredData({
                ...
                slug: "capital-quiz",
                description:
                  "Test your knowledge of world capitals in this fast-paced 60-second quiz. How many capital cities can you name?",
