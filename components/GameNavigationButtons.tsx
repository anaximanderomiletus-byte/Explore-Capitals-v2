  ...
  return (
    <div className="grid grid-cols-2 gap-3 sm:gap-4 mt-6">
      <button
        ...
        className="flex items-center justify-center gap-2 px-4 py-3 sm:py-4 bg-surface hover:bg-accent-soft border border-border hover:border-primary/25 rounded-xl text-muted hover:text-primary transition-all duration-200 group"
      >
        <LayoutGrid
          size={16}
          className="group-hover:scale-110 transition-transform"
        />
        <span className="font-semibold uppercase text-[10px] sm:text-[11px] tracking-widest whitespace-nowrap">
          ALL GAMES
        </span>
      </button>
